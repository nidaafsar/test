...
<c:if test="${command.context.guessingInd == 'true'}">
	<div class="error">
		...
		<form id="addPatient" method="get" onSubmit="checkingEmptyFields(); return false;">
<div  align="left">
<td>1.	Create Person</td><br>

<div style="margin-bottom: 5px;"><div style="width: 200px; float: left;">Given <span style ="color:red">*</span></div> <input type="text" name="gname" id="gname"/></div>

<div style="margin-bottom: 5px;"><div style="width: 200px; float: left;">Middle </div><input type="text" name="midname" /></div>

<div style="margin-bottom: 5px;"><div style="width: 200px; float: left;">Family <span style ="color:red">*</span></div><input type="text" name="fmyname" id="fmyname"/></div>

</div>
<br>
<div  align="left">
<td>2.	Patient Information</td>

<br>
<div style="margin-bottom: 5px;"><div style="width: 200px; float: left;">Identifier <span style ="color:red">*</span></div> <input type="text" name="id" id="id" readonly="readonly" value=<%=request.getSession().getAttribute("patientIdentifier")%>></div>
...
<select name="citizenship">
  <option value="birth">Citizen by birth</option>
...
<div style="margin-bottom: 5px;"><div style="width: 200px; float: left;">Urban/Rural</div>
